...
```php
\FireHub\TheCore\Support\Enums\Geo\Country::continent():\FireHub\TheCore\Support\Enums\Geo\Continent
```
...
* [\FireHub\TheCore\Support\Enums\Geo\Continent](./Continent) _Continent enum of selected country._
