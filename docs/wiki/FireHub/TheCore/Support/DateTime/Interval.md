...
| Type  | Name  | Title |
| :---  | :---  | :---  |
|static |<a href="#millenniums()">millenniums</a>||
|static |<a href="#centurys()">centurys</a>||
|static |<a href="#decades()">decades</a>||
|static |<a href="#years()">years</a>||
|static |<a href="#quarters()">quarters</a>||
|static |<a href="#months()">months</a>||
|static |<a href="#fortnights()">fortnights</a>||
|static |<a href="#weeks()">weeks</a>||
|static |<a href="#days()">days</a>||
|static |<a href="#hours()">hours</a>||
|static |<a href="#minutes()">minutes</a>||
|static |<a href="#seconds()">seconds</a>||
|static |<a href="#milliseconds()">milliseconds</a>||
|static |<a href="#microseconds()">microSeconds</a>||
||<a href="#getyears()">getYears</a>||
||<a href="#getmonths()">getMonths</a>||
||<a href="#getdays()">getDays</a>||
||<a href="#gethours()">getHours</a>||
||<a href="#getminutes()">getMinutes</a>||
||<a href="#getseconds()">getSeconds</a>||
||<a href="#getmicroseconds()">getMicroSeconds</a>||
||<a href="#addmillenniums()">addMillenniums</a>||
||<a href="#addcenturys()">addCenturys</a>||
||<a href="#adddecades()">addDecades</a>||
||<a href="#addyears()">addYears</a>||
||<a href="#addquarters()">addQuarters</a>||
||<a href="#addmonths()">addMonths</a>||
||<a href="#addfortnights()">addFortnights</a>||
...
||<a href="#addmicroseconds()">addMicroSeconds</a>||
||<a href="#submillenniums()">subMillenniums</a>||
||<a href="#subcenturys()">subCenturys</a>||
||<a href="#subdecades()">subDecades</a>||
||<a href="#subyears()">subYears</a>||
||<a href="#subquarters()">subQuarters</a>||
||<a href="#submonths()">subMonths</a>||
||<a href="#subfortnights()">subFortnights</a>||
...
|static |<a href="#__callstatic()">__callStatic</a>|### Invoking inaccessible static methods in an object context|
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::millenniums()
```
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::centurys()
```
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::decades()
```
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::years()
```
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::quarters()
```
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::months()
```
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::fortnights()
```
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::weeks()
```
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::days()
```
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::hours()
```
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::minutes()
```
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::seconds()
```
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::milliseconds()
```
...
```php
static \FireHub\TheCore\Support\DateTime\Interval::microSeconds()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::getYears()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::getMonths()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::getDays()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::getHours()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::getMinutes()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::getSeconds()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::getMicroSeconds()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addMillenniums()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addCenturys()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addDecades()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addYears()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addQuarters()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addMonths()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addFortnights()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addWeeks()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addDays()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addHours()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addMinutes()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addSeconds()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addMilliSeconds()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::addMicroSeconds()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subMillenniums()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subCenturys()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subDecades()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subYears()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subQuarters()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subMonths()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subFortnights()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subWeeks()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subDays()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subHours()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subMinutes()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subSeconds()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subMilliSeconds()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::subMicroSeconds()
```
...
```php
\FireHub\TheCore\Support\DateTime\Interval::__get(string $name):int
```
...
* [\Error](./Error) _If called property doest&#039;t exist._
...
```php
\FireHub\TheCore\Support\DateTime\Interval::__set(string $name, mixed $value):void
```
...
* [\Error](./Error) _If called method doest&#039;t exist._
* [\Error](./Error) _If method doest&#039;t have first parameter._
