...
final class Cls {
     ...
     */
    public static function methods (string $class):array {

        return self::isClass($class) ? get_class_methods($class) : throw new Error("Class $class doesn't exist!");
    ...
    public static function properties (string $class):array {
        ...
        return self::isClass($class) ? get_class_vars($class) : throw new Error("Class $class doesn't exist!");
